										...
										return function (selecting) {
											return function (state) {
												return function (viewState) {
													return {currentSets: currentSets, device: device, displayPermission: displayPermission, filter: filter, h: h, results: results, selecting: selecting, state: state, storagePermission: storagePermission, string: string, validSearch: validSearch, viewState: viewState, w: w};
												};
											};
										};
									};
...
var $author$project$Main$NoSelect = {$: 'NoSelect'};
...
var $author$project$Main$init = function (f) {
	...
	var filter = $author$project$Shared$None;
	var device = $mdgriffith$elm_ui$Element$classifyDevice(
		{height: f.h, width: f.w});
	var dataState = $author$project$Main$Loading('Checking Local Storage');
	return _Utils_Tuple2(
		$author$project$Main$Model(f.w)(f.h)(device)(f.permission)(!f.permission)('')(_List_Nil)(false)(_List_Nil)(filter)($author$project$Main$NoSelect)(dataState)(viewState),
	...
	function (msg, model) {
		switch (msg.$) {
						...
						case 'PortError':
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										state: $author$project$Main$Error(e)
									}),
								$elm$core$Platform$Cmd$none);
						case 'Status':
							var s = ipd.a;
							...
							return r ? _Utils_Tuple2(
								_Utils_update(
									model,
									{
										state: $author$project$Main$Ready($author$project$Main$Synced)
									}),
								$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
								_Utils_update(
									model,
									{
										state: $author$project$Main$Loading(s)
									}),
								$elm$core$Platform$Cmd$none);
						default:
							...
							var _v3 = model.state;
							if ((_v3.$ === 'Ready') && (_v3.a.$ === 'Getting')) {
								var s = _v3.a.a;
								return _Utils_eq(s, model.string) ? _Utils_Tuple2(m, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
									_Utils_update(
										m,
										{
											state: $author$project$Main$Ready(
												$author$project$Main$Getting(model.string))
										}),
									$author$project$Main$sendPort(
										$author$project$Shared$encodeOutPortData(
											$author$project$Shared$Query(model.string))));
							} else {
								return _Utils_Tuple2(m, $elm$core$Platform$Cmd$none);
							}
					}
				}
			case 'AllowStoragePermission':
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ToggleSelecting':
				var ss = msg.a;
				return _Utils_eq(model.selecting, ss) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{selecting: $author$project$Main$NoSelect}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{selecting: ss}),
			...
			case 'FilterSelected':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{filter: ft, selecting: $author$project$Main$NoSelect}),
					$author$project$Main$sendPort(
						$author$project$Shared$encodeOutPortData(
					...
					_Utils_update(
						model,
						{
							results: A2(
								$elm$core$List$map,
								function (item) {
									return _Utils_eq(item.hash, hash) ? _Utils_update(
										item,
										{screenshot: ''}) : item;
								},
								model.results)
			...
			case 'FocusItem':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							viewState: $author$project$Main$SingleItem(i)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ReturnToList':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{viewState: $author$project$Main$MainView}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{viewState: $author$project$Main$About}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$ReturnToList = {$: 'ReturnToList'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{
					label: $mdgriffith$elm_ui$Element$text('Return'),
					onPress: $elm$core$Maybe$Just($author$project$Main$ReturnToList)
				})
			]));
};
var $author$project$Main$AboutPressed = {$: 'AboutPressed'};
var $author$project$Main$AllowStoragePermission = {$: 'AllowStoragePermission'};
var $author$project$Main$DenyStoragePermission = {$: 'DenyStoragePermission'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				model.displayPermission ? $author$project$Main$bgColor2 : $author$project$Main$bgColor)
			]),
		_List_fromArray(
			[
				model.displayPermission ? A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$spacing(10),
				...
				_List_fromArray(
					[
							...
							]),
						{
							...
							onPress: $elm$core$Maybe$Just($author$project$Main$AllowStoragePermission)
						}),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						_List_fromArray(
							...
							]),
						{
							...
							onPress: $elm$core$Maybe$Just($author$project$Main$DenyStoragePermission)
						}),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_fromArray(
				...
				_List_fromArray(
					[
						...
						{
							label: $mdgriffith$elm_ui$Element$text('What is this?'),
							onPress: $elm$core$Maybe$Just($author$project$Main$AboutPressed)
						})
					]))
			]));
};
var $author$project$Main$FilterSelected = function (a) {
	return {$: 'FilterSelected', a: a};
};
var $author$project$Main$SelectingFilter = {$: 'SelectingFilter'};
var $author$project$Main$SelectingSet = {$: 'SelectingSet'};
var $author$project$Main$SetSelected = function (a) {
	return {$: 'SetSelected', a: a};
};
var $author$project$Main$ToggleSelecting = function (a) {
	return {$: 'ToggleSelecting', a: a};
};
...
var $author$project$Shared$validFilters = _List_fromArray(
	[$author$project$Shared$None, $author$project$Shared$Hunter, $author$project$Shared$Warlock, $author$project$Shared$Titan]);
...
var $author$project$Main$viewHeader = function (model) {
	var setToggle = A2(
		...
		{
			label: $mdgriffith$elm_ui$Element$text('View Sets'),
			onPress: $elm$core$Maybe$Just(
				$author$project$Main$ToggleSelecting($author$project$Main$SelectingSet))
		});
	...
	var input = A2(
		...
		_List_fromArray(
			[
				...
				{
					label: $mdgriffith$elm_ui$Element$Input$labelHidden('Search Box'),
					onChange: $author$project$Main$SearchString,
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							{
								label: $mdgriffith$elm_ui$Element$Input$labelHidden('Filter Selection'),
								onChange: $author$project$Main$FilterSelected,
								options: A2($elm$core$List$map, $author$project$Main$viewFilterOption, $author$project$Shared$validFilters),
								selected: $elm$core$Maybe$Just(model.filter)
							})
						]));
			case 'SelectingSet':
				return A2(
	...
	var filterbox = A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$color(
				function () {
					var _v0 = model.selecting;
					if (_v0.$ === 'SelectingFilter') {
						return $author$project$Main$accColor;
					} else {
				...
				$mdgriffith$elm_ui$Element$Events$onClick(
				$author$project$Main$ToggleSelecting($author$project$Main$SelectingFilter))
			]),
		_List_fromArray(
			[
				A2(
				...
				$mdgriffith$elm_ui$Element$text(
					$author$project$Shared$filterStr(model.filter)))
			]));
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_Utils_ap($author$project$Const$root, item.screenshot)),
					...
					$elm$json$Json$Decode$succeed(
						$author$project$Main$ImageError(item.hash)))
				]),
			_List_Nil));
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
								...
								]),
							{
								...
								src: _Utils_ap($author$project$Const$root, item.icon)
							}),
							A2(
							$mdgriffith$elm_ui$Element$paragraph,
							_List_fromArray(
								...
								[
									...
									$mdgriffith$elm_ui$Element$text(
										A2(
											$elm$core$String$join,
											' | ',
											A2($elm$core$List$cons, item.name, item.sets)))),
									A2(
									$mdgriffith$elm_ui$Element$paragraph,
									_List_Nil,
									_List_fromArray(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(item.source)
						]))
				]));
	});
var $author$project$Main$FocusItem = function (a) {
	return {$: 'FocusItem', a: a};
};
										...
										switch (_v1.$) {
											...
											default:
												...
												if (!model.validSearch) {
													...
													var _v2 = _Utils_Tuple2(model.results, syncstate);
													if (!_v2.a.b) {
														if (_v2.b.$ === 'Synced') {
															var _v3 = _v2.b;
															return A2(
